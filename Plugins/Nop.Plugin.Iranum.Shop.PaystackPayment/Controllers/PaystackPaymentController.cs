...
using Nop.Plugin.Iranum.Shop.PaystackPayment.Models;
using System.Net.Http;
using System.Threading.Tasks;
using Newtonsoft.Json.Linq;

namespace Nop.Plugin.Iranum.Shop.PaystackPayment.Controllers
{
    public class PaystackPaymentController : BasePaymentController
    {
        private readonly ISettingService _settingService;
        private readonly IPaymentService _paymentService;
        private readonly IOrderService _orderService;
        private readonly IOrderProcessingService _orderProcessingService;
        private readonly PaystackPaymentSettings _ccAvenuePaymentSettings;
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/Payment.Paystack/Views/Configure.cshtml", model);
        }
        ...
        [AdminAuthorize]
        public ActionResult PaystackAdmin()
        {
        ...
        [HttpPost]
        [AdminAuthorize]
        public ActionResult PaystackAdmin(ConfigurationModel model)
        {
            _ccAvenuePaymentSettings.Webhook = model.Webhook;
            _settingService.SaveSetting(_ccAvenuePaymentSettings);

            return PaystackAdmin();
